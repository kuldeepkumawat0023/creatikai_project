...
function Lead_Automotion() {
  ...
  const faqs = [
    {
      question: "What is AI lead automation?",
      answer:
        "AI lead automation leverages artificial intelligence to streamline and enhance the process of capturing, nurturing, scoring, and managing leads. It uses AI-driven insights to optimize lead management, personalize communication, and improve conversion rates without the need for manual intervention.",
    },
    {
      question: "How does AI improve lead automation?",
      answer:
        "AI enhances lead automation by analyzing vast amounts of data to identify patterns and predict lead behavior. It automates tasks such as lead scoring, segmentation, and personalized follow-ups, ensuring that each lead receives the right message at the right time, ultimately increasing the chances of conversion.",
    },
    {
      question: "Can AI lead automation integrate with my existing CRM?",
      answer:
        "Yes, most AI lead automation tools are designed to integrate seamlessly with popular CRM systems. This integration allows for smooth data flow and ensures that AI-driven insights are available within your existing lead management and sales processes.",
    },
  ];
      ...
      <section className="bg-[url(/traningbg-image.jpg)] h-auto w-full bg-no-repeat bg-cover">
        <div className="px-2 md:px-[120px]">
          <div className=" pt-[150px]">
            <h1 className='text-white text-6xl pl-6 p-6 font-semibold'>Lead Automation</h1>
            <p className='text-gray-500 p-3 text-[22px]'> Looking for lead automation services in Jaipur, India? Our expert team offers customized solutions to automate your lead capture, nurturing, and scoring processes, ensuring you never miss an opportunity. We integrate advanced tools with your CRM to streamline workflows and boost conversion rates. Partner with us to enhance your sales funnel and drive sustainable growth. Contact us today for a consultation!
            </p>
          </div>
          ...
          {[
            {
              icon: <FaQuinscape />,
              title: "Lead Capture",
              desc: "Lead Capture involves collecting potential customer information through forms, landing pages, or interactive content. It helps businesses build a database of prospects, nurture relationships, and convert leads into paying customers using targeted marketing strategies.",
            },
            {
              icon: <SiOpenproject />,
              title: "Lead Segmentation",
              desc: "Lead Segmentation is the process of categorizing potential customers based on demographics, behavior, or interests. It allows businesses to send personalized messages, targeting the right audience with tailored marketing strategies.",
            },
            {
              icon: <SiDatadotai />,
              title: "CRM Integration",
              desc: "CRM Integration connects your Customer Relationship Management system with other business tools like email, marketing, or sales platforms. It ensures seamless data flow, improves customer insights, enhances collaboration, and boosts efficiency by unifying all customer-related information in one place.",
            },
            {
              icon: <GiPaperWindmill />,
              title: "Follow-up Automation ",
              desc: "Follow-up automation streamlines post-interaction processes, sending timely emails, messages, or notifications to leads and customers. It improves engagement, strengthens relationships, ensures no opportunity is missed, and increases conversion rates by maintaining consistent and personalized communication automatically.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
...
export default Lead_Automotion