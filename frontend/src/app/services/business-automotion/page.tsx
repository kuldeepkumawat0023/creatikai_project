...
function Bussiness_Automotion() {
  ...
  const faqs = [
    {
      question: "What is an AI business automation generator?",
      answer:
        "An AI business automation generator is a tool or platform that uses artificial intelligence to create automated workflows and processes for businesses. It helps automate tasks such as data entry, customer communication, marketing campaigns, and more, reducing the need for manual intervention.",
    },
    {
      question: "How does an AI business automation generator work?",
      answer:
        "These generators analyze existing workflows and use AI to identify patterns and optimize processes. They can automatically create and execute workflows, integrate with other software applications, and continuously learn from data to improve efficiency over time.",
    },
    {
      question: "What are the key benefits of using an AI business automation generator?",
      answer:
        "Benefits include increased efficiency, reduced human error, cost savings, enhanced scalability, and the ability to focus on strategic tasks rather than repetitive manual work. AI-driven automation also allows for more personalized customer experiences.",
    },
  ];
    ...
    <>
      <section className="bg-[url(/traningbg-image.jpg)] h-auto w-full bg-no-repeat bg-cover">
        <div className="px-2 md:px-[120px]">
          <div className=" pt-[150px]">
            <h1 className='text-white text-6xl pl-6 p-6 font-semibold'>Business Automation</h1>
            <p className='text-gray-500 p-3 text-[22px]'> Looking for business automation services in Jaipur, India? Our expert team provides tailored automation solutions to streamline your operations, enhance productivity, and reduce costs. We specialize in automating workflows, CRM systems, and marketing processes, ensuring seamless integration with your existing infrastructure. Partner with us to transform your business with cutting-edge technology and drive sustainable growth. Get in touch for a consultation today!
            </p>
          </div>
          ...
          {[
            {
              ...
              desc: "Sales Automation refers to using software and technology to streamline and automate repetitive sales tasks, such as lead management, follow-ups, and reporting, improving efficiency, accuracy, and revenue growth.",
            },
            {
              icon: < FaBullhorn />,
              title: "Marketing automation",
              desc: "Marketing automation uses software to streamline, automate, and measure marketing tasks and workflows. It helps businesses nurture leads, personalize campaigns, improve engagement, save time, and increase efficiency by automating repetitive marketing processes across email, social media, and ads.",
            },
            {
              icon: <GiProcessor />,
              title: "Robotic Process Automation",
              desc: "Robotic Process Automation uses software robots to automate repetitive, rule-based tasks in business processes. It improves efficiency, reduces errors, saves time, and allows employees to focus on higher-value work by handling tasks like data entry, processing, and reporting.",
            },
            {
              icon: <MdHeadsetMic />,
              title: "Customer Service Automation",
              desc: "Customer Service Automation uses AI-powered tools like chatbots, automated emails, and ticketing systems to handle routine customer queries. It improves response time, ensures consistency, reduces human effort, and allows support teams to focus on complex issues requiring personal attention.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
      ...
      <section ref={ref} className='bg-black py-10 px-5 md:py-30 md:px-10 flex flex-col md:flex-row  lg:pl-[120px] lg:pr-[120px]'>
        ...
        <div className='w-full md:w-1/2 px-0 sm:pt-[50px] md:pt-[150px] md:pl-10 text-white'>
          <h2 className='text-3xl sm:text-4xl md:text-6xl font-semibold p-5'>AI Business  <br /> Automation FAQs</h2>
...
export default Bussiness_Automotion