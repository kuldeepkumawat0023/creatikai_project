            ...
            <section className="bg-[url(/traningbg-image.jpg)] h-auto w-full bg-no-repeat bg-cover">
                <div className="px-2 md:px-[120px]">
                    <div className=" pt-[150px]">
                        <h1 className='text-white text-6xl pl-6 p-6 font-semibold'>Video Creation</h1>
                        <p className='text-gray-500 p-3 text-[22px]'> Video creation AI refers to technologies and tools that use artificial intelligence to help generate, edit, or enhance video content. These AI systems, including the best AI video generators, automate various aspects of video production, making it more accessible and efficient for creators. Here’s a breakdown of how video creation AI typically works and what it can do:
                        </p>
                    </div>
