...
function Content_Creation() {
    ...
    const faqs = [
        {
            question: "What is an AI content generator?",
            answer:
                "An AI content generator is a tool or software that uses artificial intelligence to create content automatically. This can include text, images, videos, or audio. These tools typically use machine learning models, such as GPT (Generative Pre-trained Transformer), to analyze data and generate content that mimics human creation.",
        },
        {
            question: "How does an AI content generator work?",
            answer:
                "AI content generators use algorithms, often based on deep learning, to understand and mimic patterns in large datasets. For text, they use natural language processing (NLP) to generate content based on input prompts. For images, generative models like GANs (Generative Adversarial Networks) or DALL·E create visuals based on textual descriptions.",
        },
        {
            question: "Who can benefit from using an AI content generator?",
            answer:
                "Businesses, marketers, content creators, educators, and anyone who needs to produce large amounts of content quickly can benefit from AI content generators. These tools are especially useful for scaling content production, personalizing content, and automating repetitive tasks.",
        },
    ];
    ...
    return (
        <>
            <section className="bg-[url(/bgcontent-img.jpg)] h-auto w-full bg-no-repeat bg-cover">
                <div className="px-2 md:px-[120px]">
                    <div className=" pt-[150px]">
                        <h1 className='text-white text-6xl pl-6 p-6 font-semibold'>Content Creation</h1>
                        <p className='text-gray-500 p-3 text-[22px]'> AI content creation refers to the process of using artificial intelligence to generate various types of digital content. This can include text, images, videos, audio, and even interactive media. AI content creation tools leverage advanced algorithms, often based on machine learning models, to produce content that can mimic human creativity and writing styles.
                        </p>
                    </div>
            ...
            <section ref={ref} className='bg-black py-10 px-5 md:py-30 md:px-10 flex flex-col md:flex-row  lg:pl-[120px] lg:pr-[120px]'>
                ...
                <div className='w-full md:w-1/2 px-0 sm:pt-[50px] md:pt-[150px] md:pl-10 text-white'>
                    <h2 className='text-3xl sm:text-4xl md:text-6xl font-semibold p-5'>AI Content <br /> Generator FAQs</h2>
